...
export default function FeaturesPage() {
    return (
        <>
            ...
            <Layout showContactButton={true} prevPage="/home" nextPage="/design">
                <Box sx={{
                    width: "100%",
                    height: "100%",
                    background: "#2a4561",
                    padding: {xs: "100px 25px 25px", md: "200px 70px 50px"},
                    display: "flex",
